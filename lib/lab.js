...
var WX = function () {
    ...
    _createClass(WX, [{
            ...
            _index2.default.addScript('//res.wx.qq.com/open/js/jweixin-1.2.0.js', function () {
                ...
                $.ajax({
                    ...
                    success: function success(config) {
                        ...
                        _this.wxconfig = config;
                        _this.configWxShare(config);
                    },
        ...
        value: function configWxShare(config) {
            ...
            wx.ready(function () {
                _this2.setShare(_this2.shareConfig);
            });
        }
...
exports.WX = exports.Texture = exports.URL = exports.Util = exports.OS = undefined;
